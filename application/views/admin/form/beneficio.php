...
<div class="page-container">
	...
	<div class="main-content">
		...
		<form role="form" method="post" class="form-horizontal form-groups-bordered" id="formulario" action="<?php echo base_url("admin/form/".$this->router->fetch_class()."/salvar"); ?>">
			<input type="hidden" name="codigo" id="codigo" value="<?php echo $obj->id_beneficio; ?>">
				...
				<div class="panel panel-dark" data-collapsed="0">
					...
					<div class="panel-body"> 
						...
						<div class="form-group">							
							<label for="nm_beneficio" class="col-lg-2 control-label">Nome do benefício:</label>
							<div class="col-lg-6">
								<input type="text" class="form-control validate[required]" id="nm_beneficio" name="nm_beneficio" value="<?php echo $obj->nm_beneficio; ?>">
							</div>
