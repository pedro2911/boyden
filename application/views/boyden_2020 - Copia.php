             ...
             <hr>
              ...
              <div class="row mt-1">
                  ...
                  <div class="col-lg-2 div_questao_3_2_presidencia" style="display: none">
                    <input type="text" class="form-control field mask_porcentagem" id="pc_aumento_salario_presidencia" value="<?php echo getFormatNumber($obj->pc_aumento_salario_presidencia); ?>" data-tipo-dado="decimal" >
                  </div>
               ...
               <div class="row mt-1">
                  ...
                  <div class="col-lg-2 div_questao_3_2_diretoria" style="display: none">
                    <input type="text" class="form-control field mask_porcentagem" id="pc_aumento_salario_diretoria" value="<?php echo getFormatNumber($obj->pc_aumento_salario_diretoria); ?>" data-tipo-dado="decimal">
                  </div>
               ...
               <div class="row mt-1">
                  ...
                  <div class="col-lg-2 div_questao_3_2_gerencia" style="display: none">
                    <input type="text" class="form-control field mask_porcentagem" id="pc_aumento_salario_gerencia" value="<?php echo getFormatNumber($obj->pc_aumento_salario_gerencia); ?>" data-tipo-dado="decimal">
                  </div>
               ...
               <div class="row mt-1">
                  ...
                  <div class="col-lg-2" style="text-align: center">
                    <input type="text" class="form-control field mask_porcentagem" id="pc_aumento_salario_empresa_total" value="<?php echo getFormatNumber($obj->pc_aumento_salario_empresa_total); ?>" data-tipo-dado="decimal">
                  </div>
           ...
           <div class="card">
             ...
             <hr>
              ...
              <div class="row mt-1">
                  ...
                  <div class="col-lg-5 div_questao_4_2_presidencia" style="display: none;">
                    <select class="form-control field" id="nm_incentivo_longo_prazo_presidencia" onchange="abre_fecha_div_4_2_presidencia_outro();">
                      <option value=""> - selecione - </option>
                      <option value="Não há" <?php if($obj->nm_incentivo_longo_prazo_presidencia == "Não há"){ echo "selected";} ?>>Não há</option>
                      <option value="Stock Option" <?php if($obj->nm_incentivo_longo_prazo_presidencia == "Stock Option"){ echo "selected";} ?>>Stock Option</option>
                      <option value="Phantom Option / RSU (Restricted Share Units)" <?php if($obj->nm_incentivo_longo_prazo_presidencia == "Phantom Option / RSU (Restricted Share Units)"){ echo "selected";} ?>>Phantom Option / RSU (Restricted Share Units)</option>
                      <option value="Evolução P&L / EBITDA" <?php if($obj->nm_incentivo_longo_prazo_presidencia == "Evolução P&L / EBITDA"){ echo "selected";} ?>>Evolução P&L / EBITDA</option>
                      <option value="Outros" <?php if($obj->nm_incentivo_longo_prazo_presidencia == "Outros"){ echo "selected";} ?>>Outros</option>
                    </select>
                  </div>

                  <div class="col-lg-1 mt-2 div_questao_4_2_presidencia_outro" style="display: none">
                      <label for="cargo-1">Outro:</label>
                  </div>
                  <div class="col-lg-4 mt-1 div_questao_4_2_presidencia_outro" style="display: none">
               ...
               <div class="row mt-1">
                  ...
                  <div class="col-lg-5 div_questao_4_2_diretoria" style="display: none;">
                    <select class="form-control field" id="nm_incentivo_longo_prazo_diretoria" onchange="abre_fecha_div_4_2_diretoria_outro();">
                      <option value=""> - selecione - </option>
                      <option value="Não há" <?php if($obj->nm_incentivo_longo_prazo_diretoria == "Não há"){ echo "selected";} ?>>Não há</option>
                      <option value="Stock Option" <?php if($obj->nm_incentivo_longo_prazo_diretoria == "Stock Option"){ echo "selected";} ?>>Stock Option</option>
                      <option value="Phantom Option / RSU (Restricted Share Units)" <?php if($obj->nm_incentivo_longo_prazo_diretoria == "Phantom Option / RSU (Restricted Share Units)"){ echo "selected";} ?>>Phantom Option / RSU (Restricted Share Units)</option>
                      <option value="Evolução P&L / EBITDA" <?php if($obj->nm_incentivo_longo_prazo_diretoria == "Evolução P&L / EBITDA"){ echo "selected";} ?>>Evolução P&L / EBITDA</option>
                      <option value="Outros" <?php if($obj->nm_incentivo_longo_prazo_diretoria == "Outros"){ echo "selected";} ?>>Outros</option>
                    </select>
                  </div>
                  ...
                  <div class="col-lg-4 mt-1 div_questao_4_2_diretoria_outro" style="display: none">
               ...
               <div class="row mt-1">
                  ...
                  <div class="col-lg-5 div_questao_4_2_gerencia" style="display: none;">
                    <select class="form-control field" id="nm_incentivo_longo_prazo_gerencia" onchange="abre_fecha_div_4_2_gerencia_outro();">
                      <option value=""> - selecione - </option>
                      <option value="Não há" <?php if($obj->nm_incentivo_longo_prazo_gerencia == "Não há"){ echo "selected";} ?>>Não há</option>
                      <option value="Stock Option" <?php if($obj->nm_incentivo_longo_prazo_gerencia == "Stock Option"){ echo "selected";} ?>>Stock Option</option>
                      <option value="Phantom Option / RSU (Restricted Share Units)" <?php if($obj->nm_incentivo_longo_prazo_gerencia == "Phantom Option / RSU (Restricted Share Units)"){ echo "selected";} ?>>Phantom Option / RSU (Restricted Share Units)</option>
                      <option value="Evolução P&L / EBITDA" <?php if($obj->nm_incentivo_longo_prazo_gerencia == "Evolução P&L / EBITDA"){ echo "selected";} ?>>Evolução P&L / EBITDA</option>
                      <option value="Outros" <?php if($obj->nm_incentivo_longo_prazo_gerencia == "Outros"){ echo "selected";} ?>>Outros</option>
                    </select>
                  </div>
                  ...
                  <div class="col-lg-4 mt-1 div_questao_4_2_gerencia_outro" style="display: none">
             ...
             <hr class="div_questao_5_1_presidencia" style="display: none">
              ...
              <div class="row">
                <div class="col-lg-6 div_questao_5_1_gerencia" style="display: none">
                  <label for="input-1" style="color: #FFF; text-decoration: underline;">Gerencia:</label>
                </div>
             ...
             <hr>
              ...
              <div class="row mt-1">
                  ...
                  <div class="col-lg-1 div_questao_5_2_presidencia div_questao_5_2_2" style="display: none;">
                    <input type="text" class="form-control field mask_porcentagem" id="pc_maxima_contribuicao_presidente" value="<?php echo getFormatNumber($obj->pc_maxima_contribuicao_presidente); ?>" data-tipo-dado="decimal" >
                  </div>
                  ...
                  <div class="col-lg-1 div_questao_5_2_diretoria div_questao_5_2_2" style="display: none">
                    <input type="text" class="form-control field mask_porcentagem" id="pc_maxima_contribuicao_diretor" value="<?php echo getFormatNumber($obj->pc_maxima_contribuicao_diretor); ?>" data-tipo-dado="decimal" >
                  </div>

                  <div class="col-lg-1 div_questao_5_2_gerencia div_questao_5_2_2" style="display: none;"></div>

                  <div class="col-lg-1 div_questao_5_2_gerencia div_questao_5_2_2" style="display: none">
                    <input type="text" class="form-control field mask_porcentagem" id="pc_maxima_contribuicao_gerente" value="<?php echo getFormatNumber($obj->pc_maxima_contribuicao_gerente); ?>" data-tipo-dado="decimal" >
                  </div>
               ...
               <div class="row mt-1">
                  ...
                  <div class="col-lg-1 div_questao_5_2_presidencia div_questao_5_2_2" style="display: none;">
                    <input type="text" class="form-control field" id="nr_multiplo_contribuicao_presidente" value="<?php echo $obj->nr_multiplo_contribuicao_presidente; ?>">
                  </div>

                  <div class="col-lg-1 div_questao_5_2_diretoria div_questao_5_2_2" style="display: none"></div>

                  <div class="col-lg-1 div_questao_5_2_diretoria div_questao_5_2_2" style="display: none">
                    <input type="text" class="form-control field" id="nr_multiplo_contribuicao_diretor" value="<?php echo $obj->nr_multiplo_contribuicao_diretor; ?>">
                  </div>

                  <div class="col-lg-1 div_questao_5_2_gerencia div_questao_5_2_2" style="display: none"></div>

                  <div class="col-lg-1 div_questao_5_2_gerencia div_questao_5_2_2" style="display: none">
                    <input type="text" class="form-control field" id="nr_multiplo_contribuicao_gerente" value="<?php echo $obj->nr_multiplo_contribuicao_gerente; ?>">
                  </div>
      ...
      <div class="row mt-3">
        <div class="col-lg-11">
           <div class="card">
             <div class="card-body">
             <div class="card-title">
               <h5> <i class="fa fa-address-book-o"></i> &nbsp;6. Remuneração Total</h5>
             </div>
...
<script>
  ...
  <?php if(in_array("PRESIDENTE", $objTipoCargo)){ ?>
    ...
    <?php if($obj->nm_incentivo_longo_prazo_presidencia == "Outros"){ ?>
  ...
  <?php if(in_array("DIRETOR", $objTipoCargo)){ ?>
    ...
    <?php if($obj->nm_incentivo_longo_prazo_diretoria == "Outros"){ ?>
  ...
  <?php if(in_array("GERENTE", $objTipoCargo)){ ?>
    ...
    <?php if($obj->nm_incentivo_longo_prazo_gerencia == "Outros"){ ?>
  ...
  $(".tipo-cargo").click(function(){
    ...
    if(fl_presidente){
      ...
      // ZERAR CAMPOS -----------------------------------------------------
        ...
        gravar_campo("nm_incentivo_longo_prazo_presidencia", "", "text"); $("#nm_incentivo_longo_prazo_presidencia").val('');
    ...
    if(fl_diretor){
      ...
      // ZERAR CAMPOS -----------------------------------------------------
        ...
        gravar_campo("nm_incentivo_longo_prazo_diretoria", "", "text");  $("#nm_incentivo_longo_prazo_diretoria").val('');
    ...
    if(fl_gerente){
      ...
      // ZERAR CAMPOS -----------------------------------------------------
        ...
        gravar_campo("nm_incentivo_longo_prazo_gerencia", "", "text");  $("#nm_incentivo_longo_prazo_gerencia").val('');
  ...
  function abre_fecha_div_4_2_presidencia_outro(){
    ...
    if($("#nm_incentivo_longo_prazo_presidencia").val() == "Outros"){
      ...
      $("#nm_incentivo_longo_prazo_presidencia_outro").val('');
      $(".div_questao_4_2_presidencia_outro").css("display", "none");
  ...
  function abre_fecha_div_4_2_diretoria_outro(){
    ...
    if($("#nm_incentivo_longo_prazo_diretoria").val() == "Outros"){
  ...
  function abre_fecha_div_4_2_gerencia_outro(){
    ...
    if($("#nm_incentivo_longo_prazo_gerencia").val() == "Outros"){
